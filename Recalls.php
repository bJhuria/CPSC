...
<body style="height: 650px;text-align: center;background: white;">
        ...
        <div class="container-fluid"><a href="<?php echo $_SERVER['PHP_SELF']; ?>"><img src="Images/CPSClogo.png" alt="CPSC logo" width="80" class="logo"></a><i class="fas fa-flag text-dark"></i>
            <div class="collapse navbar-collapse" id="navcol-1">
                <ul class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item"><a href="logout.php"><button class="btn" type="button" style="text-align: center;margin-right: 15px; background: #FDB022; color: black; margin-left: 5px;">Log Out</button></a></li>
                </ul>
            </div>
        </div>
    </nav>
    ...
    <!-- <button id="editBTN" class="btn" type="button" style="text-align: center;margin-right: 15px; background: #FDB022; color: black;">Edit</button>
    <div id="editModal" class="modal">
        <div class="modal-content animate-top">
            <div class="modal-header">
                <h5 class="modal-title">Edit Recall</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">X</span>
                </button>
            </div>
            ...
            while ($row = mysqli_fetch_array($result)) {
                ...
                <div class='row'>
                    <div class='col-lg-10' style='text-align: left; padding-top: 6px; padding-bottom: 6px;'>
                        ...
                        <p style='margin-bottom: 0px;'><b>URL: </b>".$row['listingURL']."</p>
                    </div>
